...
ParticleEmitterBuilder& ParticleEmitterBuilder::SetAccelerationField(const Vector3& acceleration, const AABB& area) 
{
	particleEmitter_->accelerationField_ = { .acceleration = acceleration,.area = area };
	return *this;
}
