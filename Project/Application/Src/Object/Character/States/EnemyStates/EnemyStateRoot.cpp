...
#include "Application/Src/Object/Character/States/EnemyStates/EnemyStateDash.h"
#include "Application/Src/Object/Character/States/EnemyStates/EnemyStateRunTowardsPlayer.h"
...
#include "Application/Src/Object/Character/States/EnemyStates/EnemyStateEarthSpikeAttack.h"
#include "Application/Src/Object/Character/States/EnemyStates/EnemyStateLaserBeam.h"
...
{
	//アニメーションブレンドが終了したら元のブレンド時間に戻す
	if (enemy_->GetAnimator()->GetIsBlendingCompleted())
	{
		enemy_->GetAnimator()->SetBlendDuration(defaultBlendDuration);
	}
}
...
void EnemyStateRoot::InitializeTowardsPlayer()
{
	...
	//アニメーションの再生
	enemy_->GetAnimator()->PlayAnimation("Walk1", 1.0f, true);
}
...
void EnemyStateRoot::InitializeRetreat()
{
	...
	//アニメーションの再生
	enemy_->GetAnimator()->PlayAnimation("Walk2", 1.0f, true);
...
void EnemyStateRoot::InitializeSideways()
{
	...
	enemy_->GetAnimator()->PlayAnimation(animationName, 1.0f, true);
